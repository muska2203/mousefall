...
describe('executeBeginTurnIntent', () => {
  it('устанавливает activeSide и увеличивает round при ходе игрока', () => {
    ...
    const builder = new ExecutionBuilder({ type: 'TURN_BEGAN', isFieldEvent: false, side: 'player', round: 4, actorId: null });
  ...
  it('устанавливает activeSide, но не меняет round при ходе окружения', () => {
    ...
    const builder = new ExecutionBuilder({ type: 'TURN_BEGAN', isFieldEvent: false, side: 'enemies', round: 3, actorId: null });
