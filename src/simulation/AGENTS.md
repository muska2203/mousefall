...
- Внутренний урон — `damage.internal.*` (например, `damage.internal.bleeding` — тик кровотечения; сюда же относятся будущие болезни и прочий «внутренний» урон).
- Броня применяется только к внешнему физическому урону (тег `damage.physical`). Магический и внутренний урон игнорируют броню, если в обработчике не указано иное.
