...
src/content/
  ...
  templates/         # Шаблоны контента как TypeScript-модули
    ...
    pois/            # POI
    traps/           # Ловушки
    relics/          # Реликвии (постоянные пассивные бонусы забега); возвращена relic_blood_pact, остальное — в legacy/relics/
    modifiers/       # Модификаторы экипировки: stat/rule, аффиксы ролла и фирменные свойства (fixedModifiers); возвращены 3 модификатора кровавой ветки, остальное — в legacy/modifiers/
