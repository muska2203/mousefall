...
export const abilities: Record<string, ContentText> = {
  ...
  oil_flask: {
    name: 'Масляная бутыль',
    description: 'Бросок бутыли с маслом в выбранную область. Создаёт на тайлах эффект [масла](tag:effect.oil). Стоит 1 ОД, перезарядка 1.',
  },
  rain: {
    name: 'Дождь',
    description: 'Призывает ливень в выбранную область, создавая на тайлах эффект [воды](tag:effect.water). Тушит огонь и смывает масло. Стоит 1 ОД, перезарядка 1.',
  },
  counterattack: {
    name: 'Контратака',
