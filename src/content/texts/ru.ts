...
export const ruContentTexts: ContentTexts = {
  ...
  abilities: {
    ...
    parry: {
      name: 'Парирование',
      description: 'Готовит парирование на следующий ход. Тратит текущие AP (максимум 3) и даёт по одному парированию за каждое потраченное AP.',
    },
    swoop: {
      name: 'Налёт',
      description: 'Прыжок в свободную клетку в радиусе 2. Удар по земле наносит небольшой урон всем объектам с hp вокруг точки приземления и отталкивает их на одну клетку.',
    },
  },
  players: {
    'elven-ranger': {
