...
> Короткие инструкции для типовых задач. Агент открывает нужный рецепт и выполняет чеклист.
...
| [`add-prop.md`](./add-prop.md) | Добавить новый разрушаемый объект окружения (бочку, ящик и т.п.). |
| [`add-poi.md`](./add-poi.md) | Добавить новую точку интереса (алтарь и т.п. — неразрушаемый интерактивный объект). |
| [`add-trap.md`](./add-trap.md) | Добавить новую ловушку (колючки и т.п. — проходимый объект, срабатывающий на вход на клетку). |
| [`add-relic.md`](./add-relic.md) | Добавить новую реликвию (постоянный пассивный бонус забега). |
| [`add-modifier.md`](./add-modifier.md) | Добавить новый модификатор (аффикс) экипировки. |
| [`add-terrain.md`](./add-terrain.md) | Добавить новый террейн (основу пола клетки: пол, песок и т.п.). |
