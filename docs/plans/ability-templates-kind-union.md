...
3. Полная миграция всех 8 исполнителей на фабрики по kind сознательно отложена (стейджинг) — диф остаётся обозримым. **Выполнена 2026-08-12** по плану [`ability-templates-legacy-migration.md`](./ability-templates-legacy-migration.md): legacy-виды и реестр исполнителей удалены, урон способностей — фиксированные значения из шаблона.
...
| 2026-08-12 | Полная миграция оставшихся 5 legacy-видов спланирована отдельным планом: [`ability-templates-legacy-migration.md`](./ability-templates-legacy-migration.md) (фиксированный урон из шаблона, удаление формул со скейлингом и legacy-реестра, стейджинг по видам). |
