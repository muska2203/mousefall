...
- **Требуют кода:** новые формулы урона (оружия и скиллов), AI-стратегии, новые эффекты скиллов и расходников, спавн объектов в генераторе, прогрессия (реликвии/алтарь — этап 0 roadmap), боевые роллы (уклонение/крит), экономика.
